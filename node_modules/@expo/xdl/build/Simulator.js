...
exports.setInteractiveCallback = setInteractiveCallback;
...
async function confirmAsync(options) {
  var _interactiveCallback2, _interactiveCallback3;

  (_interactiveCallback2 = _interactiveCallback) === null || _interactiveCallback2 === void 0 ? void 0 : _interactiveCallback2(true);
  const {
    confirm
  ...
  (_interactiveCallback3 = _interactiveCallback) === null || _interactiveCallback3 === void 0 ? void 0 : _interactiveCallback3(false);
  return confirm;
}
/**
...
function setInteractiveCallback(callback) {
...
async function promptForDeviceAsync(devices) {
  var _interactiveCallback4, _interactiveCallback5;

  // TODO: provide an option to add or download more simulators
  // TODO: Add support for physical devices too.
  // Pause interactions on the TerminalUI
  (_interactiveCallback4 = _interactiveCallback) === null || _interactiveCallback4 === void 0 ? void 0 : _interactiveCallback4(true);
  const {
    answer
  } = await (0, _inquirer().prompt)([{
    ...
    choices: devices.map(item => {
      if (item instanceof _inquirer().Separator) {
        return item;
      } else {
        const isActive = item.state === 'Booted';
        const format = isActive ? _chalk().default.bold : text => text;
        return {
          name: `${format(item.name)} ${_chalk().default.dim(`(${item.osVersion})`)}`,
          value: item.name
        };
      }
    }),
  ...
  (_interactiveCallback5 = _interactiveCallback) === null || _interactiveCallback5 === void 0 ? void 0 : _interactiveCallback5(false);
  return answer;
}
